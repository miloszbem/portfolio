...
const RAW_COPY = {
	pl: {
		...
		heroTagline: 'Strony internetowe dla przedsiębiorców',
		cta1: 'Skontaktuj się',
		...
		p1Features: [
			...
			'Dane strukturalne pod lokalne SEO - firma rozpoznawana przez Google jako działalność lokalna',
			'Rozszerzone SEO zapewniające widoczność w wyszukiwarce',
			'Obecność firmy na mapach',
			'Poprawny podgląd linku (zdjęcie, tytuł, opis) po udostępnieniu na Facebooku czy Messengerze',
		],
		p1Summary: 'Strona wizytówkowa z pełnym zapleczem technicznym pod spodem - kancelaria jest widoczna w wyszukiwaniach i na mapach.',
		p5: 'Serwis informacyjny regionu Jarosławia i Podkarpacia',
		p5Features: [
			'Automatyczne wykrywanie nowych filmów na obserwowanych kanałach YouTube i dodawanie ich na stronę bez ręcznej pracy redakcji',
			'Automatyczny pasek "na żywo" oraz "transmisja zaplanowana" na stronie głównej, wykrywany bezpośrednio z obserwowanych kanałów YouTube, przełączający się automatycznie bez ingerencji redakcji',
			'Automatyczny znak wodny dodawany do wgrywanych zdjęć, chroniący materiały przed kopiowaniem',
			'Panel do samodzielnego dodawania artykułów i galerii zdjęć, bez potrzeby znajomości kodu',
			'Błyskawiczne wczytywanie zdjęć niezależnie od ilości opublikowanej treści',
			'Automatyczna aktualizacja strony po każdej publikacji - nowy artykuł pojawia się online bez czekania na wykonawcę',
			'Regularne kopie zapasowe treści i zdjęć',
		],
		p5Summary: 'Regionalny portal informacyjny z panelem do samodzielnej publikacji i automatyzacjami uszytymi pod pracę redakcji - nowe wideo z YouTube trafia na stronę samo, zdjęcia są zabezpieczone znakiem wodnym, a całość regularnie kopiowana na wypadek awarii.',
		...
		pkg2: {
			...
			teaser: 'Wizytówka z galerią, formularzem kontaktowym i miesięcznym raportem, który w prosty sposób pokazuje, kto i jak korzysta z Twojej strony.',
			checklist: [
		...
		analyticsItems: [
			{ lead: 'Ile razy odwiedzono Twoją stronę', text: ', dziennie i w skali miesiąca, żebyś widział czy ruch rośnie' },
		...
		quote: 'Wycena',
		indiv: 'indywidualna',
		priceDisclaimer: 'Każda wycena jest indywidualna i zależy od potrzeb Twojego biznesu, które mogą różnić się od zakresu opisanego powyżej.',
		...
		rev2: 'Współpraca przebiegła bez niespodzianek, a komunikacja była profesjonalna. Wystarczyło opisać, co chcę osiągnąć, a resztę dopracowaliśmy w trakcie rozmów. Bardzo doceniam też to, że sam mogę teraz wchodzić na panel i zmieniać treści na głównej stronie, gdy dodaję artykuł lub coś innego, bez czekania na wykonawcę. Zdecydowanie polecam.',
		...
		fPhoneInvalid: 'Numer telefonu musi mieć 9 cyfr',
	...
	en: {
		...
		heroTagline: 'Websites for entrepreneurs',
		cta1: "Let's talk",
		cta2: 'See work',
		s1: 'year of\nexperience',
		s2: 'hand-\nwritten code',
		...
		p1Features: [
			...
			'Structured data for local SEO - the business is recognized by Google as a local entity',
			'Expanded SEO ensuring visibility in search',
			'Business listed on maps',
			'Correct link preview (image, title, description) when shared on Facebook or Messenger',
		],
		p1Summary: 'A business-card site with full technical infrastructure underneath - the firm is visible in search and on maps.',
		p5: 'News portal for the Jarosław and Podkarpacie region',
		p5Features: [
			'Automatic detection of new videos on followed YouTube channels, added to the site without manual editorial work',
			'Automatic "live" and "upcoming stream" bar on the homepage, detected directly from the followed YouTube channels, switching on its own with no editorial involvement',
			'Automatic watermark added to uploaded photos, protecting content from being copied',
			'Panel for adding articles and photo galleries independently, no coding knowledge needed',
			'Instant photo loading regardless of how much content has been published',
			'Automatic site update after every publication - a new article goes live without waiting on the developer',
			'Regular backups of content and photos',
		],
		p5Summary: 'A regional news portal with a self-service publishing panel and automations built around the editorial workflow - new YouTube videos appear on the site on their own, photos are watermark-protected, and everything is backed up regularly.',
		...
		analyticsItems: [
			{ lead: 'How many times your site was visited', text: ', daily and over the month, so you can see whether traffic is growing' },
		...
		quote: 'Quote',
		indiv: 'individual',
		priceDisclaimer: 'Every quote is individual and depends on the needs of your business, which may differ from the scope described above.',
		...
		rev2: 'The collaboration went smoothly and communication was professional. I just had to describe what I wanted to achieve, and we worked out the rest together as we talked. I really appreciate that I can now log into the panel myself and update content on the homepage whenever I add an article or something else, without waiting on the developer. Highly recommend.',
		...
		fPhoneInvalid: 'Phone number must have 9 digits',
		fOptional: 'optional',
		fMsg: 'Your project',
